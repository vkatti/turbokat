...
abstract: "This post demonstrates some techniques to make your R user-defined functions unbreakable (well, almost!) by checking if function arguments are missing, not the right data type or just down-right wrong and returning meaningful error messages."
author: Vishal Katti
date: 2022-01-18
