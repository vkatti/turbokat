...
In this article, we will explore how to create functions using the popular `dplyr` verbs like `select`, `filter`, `mutate`, `arrange` and finally `group_by` with `summarise`.
